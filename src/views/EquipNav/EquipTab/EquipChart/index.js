...
const EquipChart = (props) => {
  ...
  const renderData = (item) => {
    return (
      <View style={[styles.itemWrapper, {marginHorizontal: marginH}]}>
        <Text style={[styles.itemTitle]} numberOfLines={1} ellipsizeMode="tail">
          {item.name}
        </Text>
        <View style={[styles.valueWrapper]}>
          <Text style={[styles.fontStyle, CommonStyle.fontRed]}>
            {item.value}
          </Text>
          <Text style={[styles.fontStyle, CommonStyle.fontGrey]}>
            {item.unit}
          </Text>
        </View>
