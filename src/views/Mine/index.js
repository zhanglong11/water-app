...
const Mine = (props) => {
  ...
  useEffect(() => {
    ...
    setAvatarUri(
      'http://b-ssl.duitang.com/uploads/item/201511/27/20151127114941_2ZBeA.jpeg',
    );
  }, []);
  return (
    <View style={styles.wrapper}>
      <View style={styles.title}>
        <View style={styles.header}>
          ...
          />
          <View>
            <Text style={[styles.name, styles.fontRed]}>{userName}</Text>
            <TouchableOpacity
              onPress={() => navigationTo('UserInformation', '个人信息')}>
              <Text
                style={[
                  styles.name,
                  {marginTop: 5, color: '#9D9D9D', fontSize: 14},
                ]}>
                查看详情
                <Iconfont name={'arrow'} size={14} color={'#9D9D9D'} />
              </Text>
            </TouchableOpacity>
          </View>
      ...
      <View style={styles.list}>
        <View style={[styles.item, styles.borderBottom]}>
          <View style={styles.content}>
            <Text style={styles.itemTitle}>故障提醒发送</Text>
            <Text style={styles.brief}>关闭打开请在系统设置-通知中操作</Text>
          </View>
        ...
        <TouchableOpacity onPress={() => navigationTo('Share', '分享')}>
          <View style={[styles.item, styles.borderBottom]}>
            <View style={styles.content}>
              <Text style={styles.itemTitle}>关注分享</Text>
            </View>
            <View style={styles.extra}>
        ...
        <TouchableOpacity
          onPress={() => navigationTo('SuggestReport', '意见反馈')}>
          <View style={[styles.item, styles.borderBottom]}>
            <View style={styles.content}>
        ...
        <View style={[styles.item, styles.borderBottom]}>
          <View style={styles.content}>
            <Text style={styles.itemTitle}>设备参数自动刷新</Text>
          </View>
          <View style={styles.extra}>
            <Switch
              trackColor={{false: '#D2D2D2', true: '#A8B1CF'}}
        ...
        <TouchableOpacity onPress={() => navigationTo('Update', '更新')}>
          <View style={[styles.item, styles.borderBottom]}>
            <View style={styles.content}>
              <Text style={styles.itemTitle}>版本更新</Text>
            </View>
            <View style={styles.extra}>
              <Iconfont name={'arrow'} size={20} />
            </View>
