    ...
    <View style={styles.wrapper}>
      ...
      <View style={[styles.listContainer]}>
        <View style={[styles.item, styles.borderBottom]}>
          <View style={[styles.content]}>
            <Text style={[styles.iconStyle]}>
              <Iconfont name={'gongsi-'} size={20} color={'#000'} />{' '}
            </Text>
            <Text style={styles.itemTitle}>公司名称</Text>
          </View>
          <View style={styles.extra}>
            <Text
              style={[
                styles.itemRightTitle,
                styles.itemGrey,
                styles.alignRight,
              ]}>
              华夏天信智能物联股份有限公司
        ...
        <View style={[styles.item, styles.borderBottom]}>
          <View style={[styles.content]}>
            <Text style={[styles.iconStyle]}>
              <Iconfont name={'dianhua'} size={20} color={'#000'} />{' '}
            </Text>
        ...
        <View style={[styles.item, styles.borderBottom]}>
          <View style={[styles.content]}>
            <Text style={[styles.iconStyle]}>
              <Iconfont name={'youjian'} size={20} color={'#000'} />{' '}
            </Text>
            <Text style={styles.itemTitle}>地址</Text>
          </View>
          <View style={styles.extra}>
            <Text
              style={[
        ...
        <View style={[styles.item]}>
          <View style={[styles.content]}>
            <Text style={[styles.iconStyle]}>
              <Iconfont name={'xingzhuang7'} size={20} color={'#000'} />{' '}
            </Text>
      ...
      <View style={[styles.qrcodeContainer]}>
        ...
        <View style={[styles.qrcode]}>
          <Image
            ...
            resizeMode="contain"
          />
          <Text style={styles.qrcodeText}>华夏天信</Text>
        </View>
      </View>
    </View>
  );
