  ...
  const option1 = {
    ...
    tooltip: {
      ...
      formatter: function (params, ticket, cb) {
        return `${params.seriesName}<br/>${params.name.split('_')[0]}:${
          params.value
        }(${params.percent}%)`;
      },
    },
    legend: {
      ...
      formatter: function (name) {
        const aa = `{a|${name.split('_')[0]}}{b|${name.split('_')[1]}}${
          name.split('_')[2]
        }`;
